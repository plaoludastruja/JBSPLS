...
func (c *hostMarkServiceClient) GetByHostAndUser(ctx context.Context, in *GetByUsernameAndHostRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	out := new(GetAllResponse)
	err := c.cc.Invoke(ctx, HostMarkService_GetByHostAndUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HostMarkService_GetByHostAndUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetByUsernameAndHostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HostMarkServiceServer).GetByHostAndUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HostMarkService_GetByHostAndUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HostMarkServiceServer).GetByHostAndUser(ctx, req.(*GetByUsernameAndHostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
