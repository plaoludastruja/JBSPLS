...
func request_HostMarkService_GetByUsername_0(ctx context.Context, marshaler runtime.Marshaler, client HostMarkServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_HostMarkService_GetByUsername_0(ctx context.Context, marshaler runtime.Marshaler, server HostMarkServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetByUsernameAndHostRequest
	var metadata runtime.ServerMetadata
...
func RegisterHostMarkServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HostMarkServiceServer) error {
	...
	mux.Handle("GET", pattern_HostMarkService_GetByUsername_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/hostMark.HostMarkService/GetByUsername", runtime.WithHTTPPathPattern("/hostmark/{username}/{hostUsername}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_HostMarkService_GetByUsername_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_HostMarkService_GetByUsername_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterHostMarkServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client HostMarkServiceClient) error {
	...
	mux.Handle("GET", pattern_HostMarkService_GetByUsername_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/hostMark.HostMarkService/GetByUsername", runtime.WithHTTPPathPattern("/hostmark/{username}/{hostUsername}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_HostMarkService_GetByUsername_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_HostMarkService_GetByUsername_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 1, 0, 4, 1, 5, 2}, []string{"hostmark", "username", "hostUsername"}, ""))
...
var (
	...
	forward_HostMarkService_GetByUsername_0 = runtime.ForwardResponseMessage
