...
const (
	AppointmentService_Get_FullMethodName               = "/appointment.AppointmentService/Get"
	AppointmentService_GetAll_FullMethodName            = "/appointment.AppointmentService/GetAll"
	AppointmentService_CreateAppointment_FullMethodName = "/appointment.AppointmentService/CreateAppointment"
	AppointmentService_EditAppointment_FullMethodName   = "/appointment.AppointmentService/EditAppointment"
	AppointmentService_DeleteAppointment_FullMethodName = "/appointment.AppointmentService/DeleteAppointment"
	AppointmentService_GetByAccomodation_FullMethodName = "/appointment.AppointmentService/GetByAccomodation"
)
...
type AppointmentServiceClient interface {
	...
	GetByAccomodation(ctx context.Context, in *GetAccomodationRequest, opts ...grpc.CallOption) (*GetAccomodationResponse, error)
}
...
func (c *appointmentServiceClient) GetByAccomodation(ctx context.Context, in *GetAccomodationRequest, opts ...grpc.CallOption) (*GetAccomodationResponse, error) {
	out := new(GetAccomodationResponse)
	err := c.cc.Invoke(ctx, AppointmentService_GetByAccomodation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppointmentServiceServer interface {
	...
	GetByAccomodation(context.Context, *GetAccomodationRequest) (*GetAccomodationResponse, error)
...
func (UnimplementedAppointmentServiceServer) GetByAccomodation(context.Context, *GetAccomodationRequest) (*GetAccomodationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByAccomodation not implemented")
}
...
func _AppointmentService_GetByAccomodation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAccomodationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppointmentServiceServer).GetByAccomodation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AppointmentService_GetByAccomodation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppointmentServiceServer).GetByAccomodation(ctx, req.(*GetAccomodationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AppointmentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetByAccomodation",
			Handler:    _AppointmentService_GetByAccomodation_Handler,
		},
	},
